<%-- 
    ...
    Created on : 15-Oct-2023, 1:35:21 pm
    Author     : Asus
--%>
...
<input type="text" class="form-control" maxlength="16" required name="cardnumber" placeholder>
</div>
...
<input type="text" class="form-control" maxlength="30" name="namecard" required placeholder>
</div>
...
<input type="text" class="form-control" maxlength="5" name="expdate" required placeholder="MM/YY">
</div>
...
<input type="password" maxlength="3" name="cvc" class="form-control">
</div>
</div>
</div>
</div>
...
<h6 class="card-title mb-3">Fare Summary</h6>


<div class="d-flex justify-content-between mb-4 small">
<span>TOTAL</span> <strong class="text-dark"><% out.print(s.getAttribute("totalamt")); %></strong>
</div>
...
<button class="btn btn-primary w-100 mt-2" id="btnFetch" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Payment">Place order</button>
</div>
</div>
</div>
</div>
